...
*
* DESCRIPTION:	Data extraction routines for index.html
*
***********************************************************/

 // Initialise cornerstone
 cornerstoneWADOImageLoader.external.cornerstone = cornerstone;
    ...
    function loadAndViewImage(imageId) {
        ...
        cornerstone.loadImage(imageId).then(function(image) {
			...
			// Study data
			document.getElementById('studyDescription').textContent = image.data.string('x00081030');
			document.getElementById('studyProtocol').textContent = image.data.string('x00181030');
			document.getElementById('studyAccessionNo').textContent = image.data.string('x00080050');
			...
			document.getElementById('instanceUID').textContent = image.data.string('x00080018');
            ...
            $('#statusText').html('Status: File parsed in ' + time + ' ms');	
        }, function(err) {
